    ...
    <div class="bg-gray-100 overflow-hidden">
        <div class="max-w-6xl mx-auto text-gray-800 flex flex-wrap justify-center">
            ...
            <div class="p-5 w-48 ">
                ...
                <a class="my-3 block" href="/#">XXX XXXX, Floor 4 San Francisco, CA <span class="text-teal-600 text-xs p-1"></span></a
                ><a class="my-3 block" href="/#">contact@company.com <span class="text-teal-600 text-xs p-1"></span></a>
            </div>
        </div>
    </div>
